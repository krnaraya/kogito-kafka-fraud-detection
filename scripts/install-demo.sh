...
keytool -import -trustcacerts -alias appdev-kafka-cluster -file ca.crt -keystore truststore.jks -storepass password -noprompt
...
/Users/krnaraya/Downloads/kafka_2.13-2.5.0/bin/kafka-console-producer.sh --broker-list appdev-kafka-cluster-kafka-bootstrap-appdev-aiml-demo.apps.cluster-mel-41cc.mel-41cc.example.opentlc.com:443 --producer-property security.protocol=SSL --producer-property ssl.truststore.password=password --producer-property ssl.truststore.location=/Users/krnaraya/source/aiml_webinar/kogito-kafka-fraud-detection/truststore.jks --topic transactions

/Users/krnaraya/Downloads/kafka_2.13-2.5.0/bin/kafka-console-consumer.sh --bootstrap-server appdev-kafka-cluster-kafka-bootstrap-appdev-aiml-demo.apps.cluster-mel-41cc.mel-41cc.example.opentlc.com:443 --consumer-property security.protocol=SSL --consumer-property ssl.truststore.password=password --consumer-property ssl.truststore.location=/Users/krnaraya/source/aiml_webinar/kogito-kafka-fraud-detection/truststore.jks --topic automode --from-beginning
